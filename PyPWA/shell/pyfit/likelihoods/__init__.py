...
.. note::
   In the docs for each likelihood the actual formula for each likelihood 
   is defined. To clarify some symbols: 
   
   - I°() = Intensity, this would be the function passed by the user.
   - D = The data loaded for the function.
   - MC = The acceptance data.
   - B = Binned data.
   - Q = QFactor Data.
"""
