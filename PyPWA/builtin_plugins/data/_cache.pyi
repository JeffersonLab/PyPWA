...
class _FindBasicInfo(object):
    ...
    def _setup_basic_cache_data(self, file_location: str): ...

    def _set_cache_name(self, file_location) -> str: ...

    def _get_cache_uri(self) -> str: ...

    def _set_filename_with_uri(self, file_location: str, found_location: str): ...
    ...
    @property
    def fetch_cache_location(self) -> str: ...
