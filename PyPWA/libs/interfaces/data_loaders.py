...
----------------
- ParserPlugin - Parses all data into memory
- IteratorPlugin - Returns an initialized reader or writer
- Reader - Reads a single event at a time
- Writer - Writes a single event at a time
"""
