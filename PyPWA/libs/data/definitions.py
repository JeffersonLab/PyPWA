...
class TemplateValidator(object):
    ...
    def test(self):
        raise NotImplementedError("%s does not overwrite method test. This is"
                                  "the method that you should use to overwrite"
                                  "to nest your individual tests into." %
...
class TemplateMemory(object):
    ...
    def parse(self, file_location):
        raise NotImplementedError("%s does not overwrite method parse. This is"
                                  "the method that you should overwrite to have"
                                  "the object read data into memory from disk."
                                  % self.__class__.__name__)

    def write(self, file_location, data):
        raise NotImplementedError("%s does not overwrite method write. This is"
                                  "the method that you should overwrite to have"
                                  "the object write your data to disk from"
                                  "memory" % self.__class__.__name__)
...
class TemplateReader(object):
    ...
    def reset(self):
        raise NotImplementedError("%s does not overwrite method write. This is"
                                  "the method that you should overwrite to have"
                                  "the object reset properly when this method"
                                  "is called." % self.__class__.__name__)

    @property
    def next_event(self):
        raise NotImplementedError("%s does not overwrite method write. This is"
                                  "the method that you should overwrite to have"
                                  "the object read in the next event properly"
...
class TemplateWriter(object):
    ...
    def write(self, data):
        raise NotImplementedError("%s does not overwrite method write. This is"
                                  "the method that you should overwrite to have"
                                  "the object write the data out to the disk"
                                  "correctly." % self.__class__.__name__)

    def close(self):
        raise NotImplementedError("%s does not overwrite method write. This is"
                                  "the method that you should overwrite to have"
                                  "the object close the stream properly when "
                                  "its called" % self.__class__.__name__)
