...
def mock_no_cache(monkeypatch):
    monkeypatch.setattr(
        "PyPWA.builtin_plugins.data.cache._no_cache.NoWrite",
        NoWriteTest
    )

    monkeypatch.setattr(
        "PyPWA.builtin_plugins.data.cache._no_cache.NoRead",
        NoReadTest
    )
...
def mock_standard_cache(monkeypatch):
    monkeypatch.setattr(
        "PyPWA.builtin_plugins.data.cache._standard_cache.WriteCache",
        WriteTest
    )

    monkeypatch.setattr(
        "PyPWA.builtin_plugins.data.cache._standard_cache.ReadCache",
        ReadTest
    )
...
def mock_clear_cache(monkeypatch):
    monkeypatch.setattr(
        "PyPWA.builtin_plugins.data.cache._clear_cache.ClearCache",
        ReadClearTest
    )
