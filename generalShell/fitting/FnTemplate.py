...
initial={
'A1':.01,'error_A1':.001,'fix_A1':False,#'limit_A1':(0,1000),
'A2':.01,'error_A2':.001,'fix_A2':False,'limit_A2':(0,1000),
'errordef':0.5}#initial values of fitted parameters as well as other iminuit arguments (do not change errordef) 
